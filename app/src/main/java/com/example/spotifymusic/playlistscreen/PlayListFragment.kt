...
class PlayListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (playlistId != null) {
            retrofit.getPlaylistTracks(playlistId ,authorizationHeader).enqueue(object : Callback<PlayListDataClassTrack?> {
...
//                                val rrr=track.track
                                ...
                                Log.d("TrackList", "Added track: ${track.name}, artist: ${track.artists[0].name}, imageUrl: $imageUrl")
                            }
                            ...
                            playListAdapter = PlayListAdapter(tracks) { track ,position->
                                ...
                                bundle.putInt("CLICKED_POSITION", position) // Pass the clicked position

                                // Log the data being passed to the intent
                                Log.d("IntentData", "Passing track names: $arrayNameList")
                                Log.d("IntentData", "Passing artist names: $arrayArtistNameList")
                                ...
                                Log.d("ItemClick", "Clicked on: ${track.name}, Position: $position")
                            }
